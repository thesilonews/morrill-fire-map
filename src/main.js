...
const map = new maplibregl.Map({
  ...
  style: {
    ...
    layers: [
      ...
      { id: 'roads-minor', type: 'line', source: 'protomaps', 'source-layer': 'roads', filter: ['<', ['coalesce', ['get', 'pmap:kind_detail'], 0], 3], paint: { 'line-color': '#2a2a2a', 'line-width': 0.8 } },
      { id: 'roads-major', type: 'line', source: 'protomaps', 'source-layer': 'roads', filter: ['>=', ['coalesce', ['get', 'pmap:kind_detail'], 0], 3], paint: { 'line-color': '#3a3a3a', 'line-width': ['interpolate', ['linear'], ['zoom'], 6, 0.5, 12, 2] } },
